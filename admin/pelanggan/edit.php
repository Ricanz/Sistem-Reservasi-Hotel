                        ...
                        <?php
                            ...
                            <form method="post" action="" name="submit">
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        <div class="form-floating mb-3 mb-md-0">
                                            <input class="form-control" id="nama_pelanggan" type="text" placeholder="Masukkan Nomor Kamar" name="nama_pelanggan" value="<?php echo $nama_pelanggan ?>">
                                            <label for="nama_pelanggan">Nama Pelanggan</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input class="form-control" id="no_identitas" type="text" placeholder="Masukkan Lantai" name="no_identitas" value="<?php echo $no_identitas ?>">
                                            <label for="no_identitas">Nomor Identitas</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input class="form-control" id="no_hp" type="text" placeholder="Masukkan Lantai" name="no_hp" value="<?php echo $no_hp ?>">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="form-floating mb-3 mb-md-0">
                                            <input class="form-control" id="alamat" type="text" placeholder="Masukkan Nomor Kamar" name="alamat" value="<?php echo $alamat ?>">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="form-floating mb-3 mb-md-0">
                                            <input class="form-control" id="email" type="text" placeholder="Masukkan Nomor Kamar" name="email" value="<?php echo $email ?>">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        <div class="form-floating mb-3 mb-md-0">
                                            <input class="form-control" id="orang" type="text" placeholder="Masukkan Nomor Kamar" name="orang" value="<?php echo $orang ?>">
                                            <label for="orang">Total Pengunjung</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input class="form-control" id="status" type="text" placeholder="Masukkan Lantai" name="status" value="Berisi" value="<?php echo $status ?>">
                                            ...
                                            <select class="form-select" aria-label="Default select example" name="kamar_id">
                                                ...
                                                ?>
                                                    ...
                                                    if($kamar_id == $kamars_id){ 
                                                        echo "selected"; } ?>><?php echo $no_kamar ?></option>
                                                <?php } ?>
                                            </select>
